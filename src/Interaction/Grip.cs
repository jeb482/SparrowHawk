...
namespace SparrowHawk.Interaction
{
    public class Grip : Selection
    {
        ...
        public override void draw(bool isTop)
        {
            ...
            selectedSN.transform = Util.getControllerTipPosition(ref mScene, primaryDeviceIndex == mScene.leftControllerIdx) * mVRtocontroller * mScene.tableGeometry.transform * currentTransform;
