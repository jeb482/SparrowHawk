...
namespace SparrowHawk.Interaction
{
    public class Grip : Selection
    {
        ...
        OpenTK.Vector4 new_origin;
        OpenTK.Matrix4 mVRtocontroller;
        OpenTK.Matrix4 translationM;
        ...
        public void GripObject(int trackedDeviceIndex)
        {
            if (currentState != State.SELECTION)
            {
                return;
            }
            selectedSN.transform = mScene.mDevicePose[trackedDeviceIndex] * mVRtocontroller * currentTransform;
