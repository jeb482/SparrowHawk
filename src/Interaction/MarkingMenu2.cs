...
namespace SparrowHawk.Interaction
{
    ...
    class MarkingMenu2 : Interaction
    {
        ...
        public int getNumSectors(MenuLayout2 layout)
        {
            ...
            switch (layout)
            {
                ...
                case MenuLayout2.LoftC2D2: return 2;
                case MenuLayout2.LoftC2: return 3;
        ...
        public MarkingMenu2(ref Scene scene, MenuLayout2 layout = MenuLayout2.MainMenu) : base(ref scene)
        {
            mScene = scene;
            mLayout = layout;
            ...
            switch (mLayout)
            {
                case MenuLayout2.MainMenu:
                    switch (interactionNumber)
                    {
                        ...
                        case 0:
                            ...
                            nextMenu = new MarkingMenu2(ref mScene, MenuLayout2.LoftC1);
                        ...
                        case 1:
                            ...
                            setCurSelectionKey(SelectionKey.ModelFun);
                            nextMenu = new MarkingMenu2(ref mScene, MenuLayout2.ExtrudeC1);
                        ...
                        case 2:
                            ...
                            setCurSelectionKey(SelectionKey.ModelFun);
                            nextMenu = new MarkingMenu2(ref mScene, MenuLayout2.SweepC1);
                        ...
                        case 3:
                            ...
                            setCurSelectionKey(SelectionKey.ModelFun);
                            nextMenu = new MarkingMenu2(ref mScene, MenuLayout2.RevolveC1D1);
                ...
                case MenuLayout2.LoftC1:
                    switch (interactionNumber)
                    {
                        ...
                        case 0:
                            ...
                            nextMenu = new MarkingMenu2(ref mScene, MenuLayout2.LoftD1);
                            nextMenu.setVisible(true);
                            mScene.pushInteraction(nextMenu);
                            break;
                        //Rect
                ...
                case MenuLayout2.LoftC2:
                    switch (interactionNumber)
                    {
                        ...
                        case 0:
                            ...
                            nextMenu = new MarkingMenu2(ref mScene, MenuLayout2.LoftD2);
                            nextMenu.setVisible(true);
                            mScene.pushInteraction(nextMenu);
                            break;
                        //Rect
                ...
                case MenuLayout2.ExtrudeC1:
                    switch (interactionNumber)
                    {
                        ...
                        case 0:
                            mScene.selectionDic.Add(SelectionKey.Profile1Shape, ShapeType.Circle);
                            setCurSelectionKey(SelectionKey.Profile1Shape);
                            nextMenu = new MarkingMenu2(ref mScene, MenuLayout2.ExtrudeD1);
                            nextMenu.setVisible(true);
                            mScene.pushInteraction(nextMenu);
                            break;
                        //Rect
                ...
                case MenuLayout2.SweepC1:
                    switch (interactionNumber)
                    {
                        ...
                        case 0:
                            mScene.selectionDic.Add(SelectionKey.Profile1Shape, ShapeType.Circle);
                            setCurSelectionKey(SelectionKey.Profile1Shape);
                            nextMenu = new MarkingMenu2(ref mScene, MenuLayout2.SweepD1);
                            nextMenu.setVisible(true);
                            mScene.pushInteraction(nextMenu);
                            break;
                        //Rect
                ...
                case MenuLayout2.RevolveC1D1:
                    switch (interactionNumber)
                    {
                        //Circle on planes
                        case 0:
                            mScene.selectionDic.Add(SelectionKey.ShapeOnPlanes, ShapeType.Circle);
                        ...
                        //Rect on plane
                        case 1:
                            mScene.selectionDic.Add(SelectionKey.ShapeOnPlanes, ShapeType.Rect);
                            setCurSelectionKey(SelectionKey.ShapeOnPlanes);
                            initInteractionChain(CurveID.ProfileCurve1);
                            mScene.pushInteractionFromChain();
                            break;
                        //Curve on plane
                        case 2:
                            mScene.selectionDic.Add(SelectionKey.ShapeOnPlanes, ShapeType.Curve);
                            setCurSelectionKey(SelectionKey.ShapeOnPlanes);
                            initInteractionChain(CurveID.ProfileCurve1);
                            mScene.pushInteractionFromChain();
                            break;
